...
export function Home(props: TIconProps) {
    return (
        <svg
            role="img"
            className={`size-6 fill-secondary hover:fill-white transition-[fill] duration-300 ${
                props.className ?? ""
            }`}
            aria-hidden="true"
            viewBox="0 0 24 24"
...
export function Library(props: TIconProps) {
    return (
        <svg
            role="img"
            className={`size-6 fill-[#A7A7A7] hover:fill-white transition-[fill] duration-300 ${
                props.className ?? ""
            }`}
            aria-hidden="true"
            viewBox="0 0 24 24"
